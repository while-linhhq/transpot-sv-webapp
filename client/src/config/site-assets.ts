...
export const siteAssets = {
  ...
  galleryMedia: [
    ...
    { type: 'video', src: '/ảnh và video bổ sung/0511.mp4' },
    { type: 'video', src: '/ảnh và video bổ sung/7842887009379.mp4' },
    ...
    { type: 'video', src: '/file ảnh , video chuyển nhà/7790382726053.mp4' },
    { type: 'video', src: '/file ảnh , video chuyển nhà/7812685939856.mp4' },
    ...
    { type: 'video', src: `${videos}/0511.mp4` },
    { type: 'video', src: `${videos}/271781892827118795487.mp4` },
    { type: 'video', src: `${videos}/85356601998674016388.mp4` },
  ],
} as const;
